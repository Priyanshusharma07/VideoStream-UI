...
export function HlsPlayer({ src, poster, autoPlay = false, onFirstPlay }: Props) {
  ...
  return (
    <div className="group relative h-full w-full overflow-hidden rounded-2xl bg-black">
      ...
      {/* Custom Controls Bar */}
      {!error && (
        <div className="absolute inset-x-0 bottom-0 flex items-center gap-3 bg-gradient-to-t from-black/80 to-transparent px-4 pb-4 pt-10 opacity-0 transition-opacity duration-200 group-hover:opacity-100">
          {/* Play / Pause */}
          <button
            type="button"
